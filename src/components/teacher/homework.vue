        ...
        <v-container fluid fill-height>
          <v-layout align-center justify-center>
            <v-flex xs12 sm12 md6>
              ...
              <v-card-actions>
                <v-spacer></v-spacer>
                <v-btn dark color="pink darken-3" @click="handleSubmit"
                  >create</v-btn
                >
              </v-card-actions>
              <br /><br />
...
export default {
  ...
  methods: {
    handleSubmit() {
      ...
      axios
        .post(
          `http://localhost:2000/api/Homework/file-upload/${this.$route.params.tid}&&${this.$route.params.cid}`,
          formData,
          {}
        )
        .then((res) => {
